...
#from _3_2_cough_data_prepare_noncough_1_1 import prepare_cough

#hparams_file = "train_4_1.yaml"##

# Brain class for speech enhancement training
class CghBrain(sb.Brain):
...
def dataio_prep(hparams):
    ...
    def audio_pipeline(wav):
        ...
        sig_t = sb.dataio.dataio.read_audio(wav)
        sig = sig_t[:]
        return sig

    # Define label pipeline:
    @sb.utils.data_pipeline.takes("cougher")
    @sb.utils.data_pipeline.provides("cougher", "spk_id_encoded")
    def label_pipeline(cougher):
        yield cougher
        spk_id_encoded = label_encoder.encode_label_torch(cougher)
